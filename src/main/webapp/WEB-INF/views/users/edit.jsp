...
<head>
  ...
  <title>Edit Profile - Car Rental Service</title>
  ...
  <div class="row">
    <div class="col-md-8 offset-md-2">
      <div class="card">
        ...
        <div class="card-body">
          <form action="<c:url value='/users/edit'/>" method="post" class="needs-validation" novalidate>
            <!-- Common user fields -->
            <div class="row mb-3">
              <div class="col-md-6">
            ...
            <!-- Specific fields for CustomerUser -->
            ...
            <!-- Hidden fields to maintain type -->
            ...
            <div class="d-grid gap-2">
              ...
              <a href="<c:url value='/users/profile'/>" class="btn btn-outline-secondary">Cancel</a>
            </div>
          </form>
        </div>
      </div>
